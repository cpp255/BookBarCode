...
public final class HttpHelper {
	...
	public enum ContentType {
		/** HTML-like content type, including HTML, XHTML, etx.*/
		HTML,
		/**JSON content*/
		JSON,
		/** Plain text content*/
	...
	private static int safelyConnect(String uri, HttpURLConnection connection) throws IOException {
		...
		try {
			...
			// Again seen this in the wild for bad header fields in the sever response? or bad reads.
	...
	public static URI unredirect(URI uri) throws IOException {
		...
		try {
			...
			case 307:		// No cointstant for 307 Temporary Redirect ? 
